...
*┌◦ Nama BOTz :* *${pushName}*
*│◦ Version BOTz :* *v.1.03*
*│◦ Nomor Creator :* *https://Wa.me/6281775098426*
*│◦ YouTube :* *https://www.youtube.com/@Xyura_Official*
*│◦ Status :* *Owner Bot*
*│◦ Base Ori :* *HanszzzBotz*
*└◦ Jenis Script :* *Xyura - Official*
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
...
*GRUP INFO PANEL*
*https://chat.whatsapp.com/EkM1StzxYRKGGcSvjjFrsr*
...
*_© Nafudoshika-MD`,
          ...
          if (regexInfo.test(msgTxt)) {
            ...
            logging("info", `Get Message`, msgTxt);
            try {
              const templateText = `*Nafudoshika-MD* | Group info\n\n*Group Name :* ${
            ...
            if (!messagePushCont) {
              try {
                await reybot.sendMessage(
                  groupId,
                  {
                    text: `*Nafudoshika-MD* | Push contact
...
*YT : https://www.youtube.com/@Xyura_Official*`,
                    mentions: ["6285926340758@s.whatsapp.net"],
                  },
                  { quoted: msg }
                );
          ...
          if (regexSaveUsers.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: `*Nafudoshika-MD* | Save Users
*Save Users Start*
*Total Member Group :* ${groupParticipants.length}
*YT : https://www.youtube.com/@Xyura_Official*`,
                  mentions: ["6285926340758@s.whatsapp.net"],
          ...
          if (saveContactsRegex.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: `*Nafudoshika-MD* | Save Contacts
*Save Contacts Start*
*Total Member Group :* ${groupParticipants.length}
*YT : https://www.youtube.com/@Xyura_Official*`,
                  mentions: ["6285926340758@s.whatsapp.net"],
            ...
            if (contacts.length === 0) {
              try {
                await reybot.sendMessage(
                  groupId,
                  {
                    text: `*Nafudoshika-MD* | Export Contact
          ...
          if (dropUser.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*Nafudoshika-MD* | Drop Database Users\n\n*Baik _Tunggu Sebentarr_*",
                  mentions: ["6285926340758@s.whatsapp.net"],
                },
                { quoted: msg }
              );
          ...
          if (dropContact.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*Nafudoshika-MD* | Drop Database Contacts\n\n*Baik _Tunggu Sebentart_*",
                  mentions: ["6285926340758@s.whatsapp.net"],
                },
                { quoted: msg }
              );
